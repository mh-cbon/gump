...
func TestGumpIncPrereleaseAlpha(t *testing.T) {
  ...
  tags, err := repoutils.List("git", "/home/vagrant/git")
	...
	if contains(tags, "2.0.0-alpha")==false {
		t.Errorf("Expected tags to contain 2.0.0-alpha, but it was not found in %s\n", tags)
	}
}
...
func TestGumpIncPrereleaseAlphaTwice(t *testing.T) {
  ...
  tags, err := repoutils.List("git", "/home/vagrant/git")
	...
	if contains(tags, "2.0.0-alpha-1")==false {
		t.Errorf("Expected tags to contain 2.0.0-alpha-1, but it was not found in %s\n", tags)
	}
}
...
func TestGumpIncPrereleaseAlphaToBeta(t *testing.T) {
  ...
  tags, err := repoutils.List("git", "/home/vagrant/git")
	...
	if contains(tags, "2.0.0-beta")==false {
		t.Errorf("Expected tags to contain 2.0.0-beta, but it was not found in %s\n", tags)
	}
}
...
func TestGumpIncPrereleaseBetaTwice(t *testing.T) {
  ...
  tags, err := repoutils.List("git", "/home/vagrant/git")
	...
	if contains(tags, "2.0.0-beta-1")==false {
		t.Errorf("Expected tags to contain 2.0.0-beta-1, but it was not found in %s\n", tags)
	}
}
...
func TestGumpWithOkVersionScripts(t *testing.T) {
  ...
  tags, err := repoutils.List("git", "/home/vagrant/git_with_ok_scripts")
	...
	if contains(tags, "0.0.0-beta")==false {
		t.Errorf("Expected tags to contain 0.0.0-beta, but it was not found in %s\n", tags)
	}
}
...
func TestGumpWithKoScripts(t *testing.T) {
  ...
  tags, err := repoutils.List("git", "/home/vagrant/git_with_ko_scripts")
	...
	if contains(tags, "0.0.0-beta")==true {
		t.Errorf("Expected tags to not contain 0.0.0-beta, but it was found in %s\n", tags)
	}
}
